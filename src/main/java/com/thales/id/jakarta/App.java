...
public class App implements CommandLineRunner {
	...
	public void run(String... args) {
		...
		String CTS_URL 							= "https://192.168.1.13";
		...
		String CTS_USER_NAME 					= "admin";
		String CTS_USER_PASSWORD 				= "Thales123!";
		String CTS_TOKEN_TEMPLATE 				= "template02";
		String CTS_TOKEN_GROUP 					= "tokenGroup2";

		//CADP configuration
		String CADP_NAE_VERSION 				= "2.4";
		String CADP_NAE_IP 						= "192.168.1.14";
		String CADP_NAE_PORT 					= "9000";
		...
		String CADP_KEY_NAME_DEFAULT 			= "ctsKey2";
		String CADP_DEFAULT_ALGO 				= "AES";
		String CADP_USERNAME_DEFAULT			= "admin";
		String CADP_PASSWORD_DEFAULT			= "Thales123!";
