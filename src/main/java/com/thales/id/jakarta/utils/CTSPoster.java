...
public class CTSPoster {
    ...
    /*
    private static String CTS_URL = "https://192.168.1.13";

    private static String CTS_TOKENIZE_URL = String.format("%s/vts/rest/v2.0/tokenize/", CTS_URL);

    private static String CTS_DETOKENIZE_URL = String.format("%s/vts/rest/v2.0/detokenize/", CTS_URL);
    */
